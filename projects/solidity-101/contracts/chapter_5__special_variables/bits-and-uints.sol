...
/**
  ...
  In general you want to simply use uint except in specific cases. The idea is to
  develop smart contracts that are computationally cost efficient.

 */

contract BitsAndUints {
